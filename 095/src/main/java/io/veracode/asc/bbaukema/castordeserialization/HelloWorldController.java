...
public class HelloWorldController {
    ...
    public String index() throws MarshalException, ValidationException, IOException, MappingException {
        ...
        // Mapping of Allowed with Dangerous field.
        mappingString += "<class ";
        ...
        mappingString += "<field name=\"Dangerous\"\n" +
                "                type=\"io.veracode.asc.bbaukema.castordeserialization.Dangerous\">\n" +
                "            <bind-xml name=\"io.veracode.asc.bbaukema.castordeserialization.Dangerous\"/>\n" +
                "         </field>";
